<a class="sidebar-menu-list">
    ...
    <ul class="dropdown-menu sidebar-dropdown-open d-md-none d-lg-none d-xl-none d-xxl-none"
        ...
        <li><a class="dropdown-item" href="{{route('admin.profile.edit')}}">My Account</a></li>
    ...
    <ul class="dropdown-menu sidebar-dropdown-open" aria-labelledby="dropdownMenuButton4">
        ...
        <li><a class="dropdown-item" href="{{route('admin.lesson-content.index')}}">Lessons</a></li>
        <li><a class="dropdown-item" href="{{route('admin.question.index')}}">Questions</a></li>
        <li><a class="dropdown-item" href="{{route('admin.type.index')}}">Question Categories</a></li>
    </ul>
    ...
    <ul class="dropdown-menu sidebar-dropdown-open" aria-labelledby="dropdownMenuButton3">
        ...
        <li><a class="dropdown-item" href="{{route('admin.payment-plan.index')}}">Payment Plans</a></li>
        <li><a class="dropdown-item" href="{{route('admin.package.index')}}">Packages</a></li>
        <li><a class="dropdown-item" href="{{route('admin.coupon.index')}}">Coupons</a></li>
    </ul>
    ...
    <ul class="dropdown-menu sidebar-dropdown-open" aria-labelledby="dropdownMenuButton2">
        ...
        <li><a class="dropdown-item" href="{{route('admin.language.index')}}">Language Options</a></li>
        <li><a class="dropdown-item" href="{{route('admin.group.index')}}">License Groups</a></li>
        <li><a class="dropdown-item" href="{{route('admin.period.index')}}">Periods</a></li>
        <li><a class="dropdown-item" href="{{route('admin.car-type.index')}}">Vehicle Types</a></li>
    </ul>
