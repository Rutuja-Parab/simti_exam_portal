        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    <h4><a href="{{ route('manager.course-teacher.create') }}"
                            class="btn btn-success">{{ __('manager/menu.teacher_create') }}</a></h4>
                </div>
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>{{ $user->phone }}</td>
                                    <td class="{{ $user->status == 1 ? 'text-success' : 'text-danger' }} fw-bold">
