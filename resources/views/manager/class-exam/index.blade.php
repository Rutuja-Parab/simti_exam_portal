        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    <h4><a href="{{ route('manager.class-exam.create') }}"
                            class="btn btn-success">{{ __('manager/menu.class_exam_create') }}</a></h4>
                </div>
                        ...
                        <tbody>
                            @foreach ($classExams as $exam)
                                <tr>
                                    ...
                                    <td class="{{ $exam->status == 1 ? 'text-success' : 'text-danger' }} fw-bold">
                                        {{ $exam->status == 1 ? 'Active' : 'Inactive' }}</td>
                                    <td>
                                        <a href="{{ route('manager.class-exam.edit', $exam->id) }}">
                                            <i
                                                class="bi {{ $exam->status == 1 ? 'bi-eye-slash' : 'bi-eye' }} text-dark"></i>
                                        </a>
                                        <button
