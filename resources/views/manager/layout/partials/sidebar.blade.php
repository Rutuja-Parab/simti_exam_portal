<a class="sidebar-menu-list">
    ...
    <ul class="dropdown-menu sidebar-dropdown-open d-md-none d-lg-none d-xl-none d-xxl-none"
        ...
        <li><a class="dropdown-item" href="{{ route('manager.invoice.index') }}">{{ __('manager/menu.invoices') }}</a>
        </li>
    ...
    <ul class="dropdown-menu sidebar-dropdown-open" aria-labelledby="dropdownMenuButton3">
        ...
        <li><a class="dropdown-item"
                href="{{ route('manager.user.results') }}">{{ __('manager/menu.trainee_report') }}</a>
        </li>
        <li><a class="dropdown-item"
                href="{{ route('manager.user.create') }}">{{ __('manager/menu.new_trainee') }}</a></li>
        <li><a class="dropdown-item"
    ...
    <ul class="dropdown-menu sidebar-dropdown-open" aria-labelledby="dropdownMenuButton2">
        ...
        <li><a class="dropdown-item"
                href="{{ route('manager.appointment.setting') }}">{{ __('manager/menu.appointment_setting') }}</a>
        </li>
    </ul>
</a>
