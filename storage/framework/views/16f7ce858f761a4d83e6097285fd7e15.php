<a class="sidebar-menu-list">
    <a class="list-group-item list-group-item-action d-md-none d-lg-none d-xl-none d-xxl-none" type="button"
       id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
        <div class="profile-info-icon-sidebar me-1"><span><?php echo e(auth()->user()->name[0]); ?></span></div>
        <span class="sidebar-menu-text fs-6"><?php echo e(auth()->user()->name .' '. auth()->user()->surname); ?></span>
...
<?php /**PATH C:\xampp\htdocs\simti\resources\views/admin/layout/partials/sidebar.blade.php ENDPATH**/ ?>